		...
		<div id="right-content">
			<table id="content-table">
				<tr>
					...
					<td class="form-td2"><input class="form-input1" id="nickname" type="text" value="<?php echo ($nickname); ?>" disabled="true"/></td>
					...
					<td class="form-td2">
						<table>
							<tr>
								...
								<td>
									<input type="file" id="imageInput" name="imageInput" onchange="inputImageFile()" disabled="true"/>
				...
				<tr>
					...
					<td class="form-td2"><input class="form-input1" id="email" type="text" value="<?php echo ($email); ?>" disabled="true"/></td>
					<td><a class="form-td3">请输入正确的邮箱格式</a></td>
				</tr>
				<tr>
					<td class="form-td1"><a class="form-label">岗位：</a></td>
					<td class="form-td2"><input class="form-input1" id="jobs" type="text" value="<?php echo ($jobs); ?>" disabled="true"/></td>
					<td><a class="form-td3">不超10字</a></td>
				</tr>
				<tr>
					<td class="form-td1"><a class="form-label">单位：</a></td>
					<td class="form-td2"><input class="form-input1" id="company" type="text" value="<?php echo ($company); ?>" disabled="true"/></td>
					<td><a class="form-td3">不超20字</a></td>
				</tr>
				<tr>
					<td class="form-td1"><a class="form-label">介绍：</a></td>
					<td class="form-td2"><textarea class="form-textarea" id="introduction" disabled="true"><?php echo ($introduction); ?></textarea></td>
